...
export class SpecialityComponent implements OnInit {
  ...
  public updateSpeciality(speciality: Speciality): void {
    ...
    this.specialityService
      .updateSpeciality(speciality.specialityId, speciality)
      .subscribe(observer);
  }
  ...
  public search(form: NgForm): void {
    let filteredSpecialities = this.allSpecialities.filter((speciality) =>
      speciality.specialityName
        .toLowerCase()
        .includes(form.value.specialityName.toLowerCase())
    );
